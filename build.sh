cc generator.c amd64.S -nostdlib -fno-stack-protector -fno-builtin -O3 -march=native -o generator
...
cc main.c      amd64.S -nostdlib -fno-stack-protector -fno-builtin -O3 -march=native -I.
